...
<pre lang="markdown"> ### 📁 Project Structure ``` LibraryManager/ ├── GUI/ # All Windows Forms (UI) │ ├── AuthorsForm.cs # Authors management form │ ├── AuthorsForm.Designer.cs │ ├── AuthorsForm.resx │ ├── BooksForm.cs # Books management form │ ├── BooksForm.Designer.cs │ ├── BooksForm.resx │ ├── MainForm.cs # Main window (menu + book table) │ ├── MainForm.Designer.cs │ ├── MainForm.resx │ ├── ReadersForm.cs # Readers management form │ ├── ReadersForm.Designer.cs │ └── ReadersForm.resx │ ├── Models/ # Data models for the database │ ├── Authors.cs # Author entity │ ├── Book.cs # Book entity │ └── Reader.cs # Reader entity │ ├── Services/ # Infrastructure logic │ └── DatabaseService.cs # Database initialization │ ├── Program.cs # Application entry point └── README.md # Project documentation (this file) ``` </pre>
